...
import imageHomeLogo from "../../image/homeLogo/homeLogo.png";
  ...
  return (
    <div className="main-side-menu">
      <div className="d-flex flex-column justify-content-center align-items-center">
        <div className="mt-2">
          <Link to="/">
            <img alt="home logo" src={imageHomeLogo} className="img-home-logo" />
          </Link>
        </div>
        <div className="mt-5">
          <Link to="/" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", textDecoration: "none" }}>
